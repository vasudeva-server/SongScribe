...
public class ToggleTupletCommand extends Message {

    private final TupletAction action;

    public ToggleTupletCommand(TupletAction action) {
        this.action = action;
    }

    public TupletAction getAction() {
        return action;
    }
