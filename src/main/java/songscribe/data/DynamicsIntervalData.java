...
public final class DynamicsIntervalData {

    public static final String SEPARATOR = ",";

    private DynamicsIntervalData() {}
    ...
    public static void setX1Shift(Interval interval, int x1Shift) {
        interval.setData(
            createDataString(x1Shift, getX2Shift(interval), getYShift(interval))
        );
    }

    public static void setX2Shift(Interval interval, int x2Shift) {
        interval.setData(
            createDataString(getX1Shift(interval), x2Shift, getYShift(interval))
        );
    }

    public static void setYShift(Interval interval, int yShift) {
        interval.setData(
            createDataString(getX1Shift(interval), getX2Shift(interval), yShift)
        );
    }
