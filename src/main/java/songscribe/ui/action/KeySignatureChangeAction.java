 ...
 * {@link KeySignatureElement}'s position invariant for why some positions are refused.
 */
public final class KeySignatureChangeAction extends UIAction implements InsertionPointMode.Client {
     ...
     *
     * <ul>
     *   <li><b>Index 0.</b> A {@link KeySignatureElement} is never the first element of a line —
    ...
    private static boolean holdsKeySignature(Line line, int index) {
        return index >= 0
            ...
            && line.getElement(index).getType() == ElementType.KEY_SIGNATURE;
    }
