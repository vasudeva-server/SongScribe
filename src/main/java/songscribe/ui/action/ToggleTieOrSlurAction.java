...
public class ToggleTieOrSlurAction extends UIAction {

    public ToggleTieOrSlurAction() {
        super(
            "Toggle Tie/Slur",
            "@\uF373",
            20,
            "toggle-tie",
            "Tie/untie or slur/unslur selected notes",
            false,
            KeyEvent.VK_T,
            0
        );
    ...
    public void musicSelectionDidChange(
        ...
        if (updateEnabledState()) {
            setEnabled(message.getScore().canToggleTieOrSlur());
        }
    }

    @Override
    public void actionPerformed(ActionEvent e) {
        MessageCenter.post(new ToggleTieOrSlurMessage());
    }
}
