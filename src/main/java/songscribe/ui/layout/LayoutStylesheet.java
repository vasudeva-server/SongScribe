...
public final class LayoutStylesheet {
     ...
     */
    public static final double TRILL_MARGIN_SS = 1.0;  // 8px
     ...
     */
    public static final double FERMATA_MARGIN_SS = 0.5;  // 4px
     ...
     */
    public static final double ARTICULATION_MARGIN_FROM_NOTE_SS = 0.5;  // 4px
