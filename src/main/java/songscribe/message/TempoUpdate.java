...
public class TempoUpdate extends Message {

    @Nullable private final Tempo.Type tempoType;
    @Nullable private final Integer visibleTempo;
    @Nullable private final String tempoDescription;
    @Nullable private final Boolean showTempo;
