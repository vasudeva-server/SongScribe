...
public class MetadataUpdate extends Message {

    @Nullable private final String title;
    @Nullable private final String place;
    @Nullable private final String year;
    @Nullable private final String number;
    @Nullable private final String attribution;
    @Nullable private final Integer month;
    @Nullable private final Integer day;
    @Nullable private final Boolean unofficialTranslation;
