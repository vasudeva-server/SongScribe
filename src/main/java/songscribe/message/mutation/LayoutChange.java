 ...
 */
public record LayoutChange(LayoutField field, @Nullable Object oldValue, @Nullable Object newValue)
    implements Mutation {

    public LayoutChange {
        FieldTypeValidator.validate("LayoutChange", field, field.getExpectedType(), oldValue, newValue);
    }
}
