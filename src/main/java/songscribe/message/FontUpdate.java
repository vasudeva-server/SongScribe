...
public class FontUpdate extends Message {

    @Nullable private final Font titleFont;
    @Nullable private final Font lyricsFont;
    @Nullable private final Font attributionFont;
    @Nullable private final Font annotationFont;
