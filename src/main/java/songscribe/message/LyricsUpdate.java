...
public class LyricsUpdate extends Message {

    @Nullable private final String lyrics;
    @Nullable private final String underLyrics;
    @Nullable private final String translatedLyrics;
    @Nullable private final String banglaLyrics;
